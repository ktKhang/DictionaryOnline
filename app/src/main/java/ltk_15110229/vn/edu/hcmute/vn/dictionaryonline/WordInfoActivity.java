...
public class WordInfoActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    private void mappings(){
        txtWord = (TextView) findViewById(R.id.txtWordInfo);
        txtDetail1 = (TextView) findViewById(R.id.txtDetail1Info);
        txtDetail2 = (TextView) findViewById(R.id.txtDetail2Info);
